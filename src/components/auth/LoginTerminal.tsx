    ...
    <div className="flex flex-col items-center justify-center min-h-screen p-4">
      ...
      >
        <div className="flex items-center gap-2 mb-6 border-b border-cyber-blue/20 pb-4">
          ...
          <h1 className="text-sm font-bold tracking-widest text-cyber-blue uppercase">{t.terminal.title}</h1>
        </div>
          ...
          <form onSubmit={handleLogin} className="space-y-6">
            <div className="space-y-4">
              <div className="space-y-1">
                <label className="text-[10px] uppercase tracking-tighter text-cyber-blue/60 font-bold">{t.terminal.identifier}</label>
              ...
              <div className="space-y-1">
                <label className="text-[10px] uppercase tracking-tighter text-cyber-blue/60 font-bold">{t.terminal.passkey}</label>
                <div className="relative">
                  <input
                    type="password"
                    value={password}
